...
public class MySliceProvider extends SliceProvider {
    ...
    public Slice onBindSlice(Uri sliceUri) {
        switch (sliceUri.getPath()) {
            ...
            case "/wifi":
                return createActionWithActionInRow(sliceUri);
    ...
    public Slice createSliceWithActionInHeader(Uri sliceUri) {
        ...
        if (takeNoteIntent == null) {
            takeNoteIntent = PendingIntent.getActivity(getContext(), 0, new Intent("com.sunny.slice.action"), 0);
        }
        ...
        if (voiceNoteIntent == null) {
            voiceNoteIntent = PendingIntent.getActivity(getContext(), 0, new Intent(getContext(), MainActivity.class), 0);
        }
        ...
        if (cameraNoteIntent == null) {
            cameraNoteIntent = PendingIntent.getActivity(getContext(), 0, new Intent(getContext(), MainActivity.class), 0);
        }
    ...
    public Slice createActionWithActionInRow(Uri sliceUri) {
        ...
        if (wifiSettingsPendingIntent == null) {
            wifiSettingsPendingIntent = PendingIntent.getActivity(getContext(), 0, new Intent("com.sunny.slice.action"), 0);
        }
        SliceAction primaryAction = SliceAction.create(wifiSettingsPendingIntent,
                IconCompat.createWithResource(getContext(), R.drawable.ic_wifi_foreground),
                ListBuilder.ICON_IMAGE,
                "Wi-Fi Settings"
        );

        // Toggle action - toggle wifi.
        if (wifiTogglePendingIntent == null) {
            wifiTogglePendingIntent = PendingIntent.getActivity(getContext(), 0, new Intent(getContext(), MainActivity.class), 0);
        }
    ...
    public Slice createSliceWithGridRow(Uri sliceUri) {
        ...
        if (pendingIntent == null) {
            pendingIntent = PendingIntent.getActivity(getContext(), 0, new Intent(getContext(), MainActivity.class), 0);
        }
        ListBuilder listBuilder = new ListBuilder(getContext(), sliceUri, ListBuilder.INFINITY)
                .setHeader(
                        // Create the header.
    ...
    public Slice createSliceWithRange(Uri sliceUri) {
        ...
        // Construct the parent.
        if (volumeChangedPendingIntent == null) {
            volumeChangedPendingIntent = PendingIntent.getActivity(getContext(), 0, new Intent(getContext(), MainActivity.class), 0);
        }
        ListBuilder listBuilder = new ListBuilder(getContext(), sliceUri, ListBuilder.INFINITY)
